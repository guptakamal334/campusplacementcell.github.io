...
Public Class college_report
    ...
    Private Sub college_report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cs = "Data Source=DESKTOP-O6OC1N4\KAMALSQL;Initial Catalog=vbdata;Integrated Security=True"
        con = New SqlConnection(cs)
        con.Open()
        cmd = New SqlCommand("select * from college", con)
