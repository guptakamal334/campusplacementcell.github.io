...
Public Class College_rec
	...
	Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
		...
		con.Open()
        cmd = New SqlCommand("INSERT INTO college values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" +
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        con = New SqlConnection(cs)
        con.Open()
        cmd1 = New SqlCommand("select * from college where college_code=@college_code", con)
        cmd1.Parameters.Add("@college_code", SqlDbType.VarChar).Value = TextBox1.Text
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            cmd2 = New SqlCommand("Update college set   college_name='" + TextBox2.Text + "', Department='" +
                                  TextBox3.Text + "', principle='" + TextBox4.Text + "', rank='" + TextBox5.Text + "', address='" +
                                  TextBox6.Text + "', city='" + TextBox7.Text + "', state='" + TextBox8.Text + "', contact_no1='" +
                                  TextBox9.Text + "', contact_no2='" + TextBox10.Text + "' where college_code='" +
                                  TextBox1.Text + "'", con)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        con = New SqlConnection(cs)
        con.Open()
        cmd3 = New SqlCommand("delete from college where college_code='" + TextBox1.Text + "'", con)
